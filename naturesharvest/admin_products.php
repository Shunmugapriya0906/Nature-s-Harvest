   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <select name="category" class="box" required>
            ...
            <option value="Health And Nutrition">Health Care</option>
         ...
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="Enter Product Price In INR">
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price">MRP:  ₹<?= $fetch_products['price']; ?>/-</div>
